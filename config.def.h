...
static const unsigned int enablegaps= 1;       /* enablegaps by default*/
...
static const char col_purple[]      = "#65106b";
static const char col_orange[]      = "#f29a02";
static const char col_yellow[]      = "#ddea25";
static const char col_pink[]        = "#e718f9";
static const char col_cyan[]        = "#3686aa";
static const char col_lavender[]    = "#846da8";

static const char col1[]            = "#cecece";
static const char col2[]            = "#534f54";
...
static const char *colors[][3]      = {
        /*               fg         bg         border   */
        [SchemeNorm] = { col_orange, col_dcyan, col_purple },
        [SchemeCol1]  = { col1,      col_purple, col_purple },
        [SchemeCol2]  = { col2,      col_lavender, col_purple },
        [SchemeCol3]  = { col3,      col_cyan, col_purple },
        [SchemeCol4]  = { col4,      col_cyan, col_purple },
        [SchemeCol5]  = { col5,      col_cyan, col_purple },
        [SchemeCol6]  = { col6,      col_cyan, col_purple },
        [SchemeSel]  = { col_yellow, col_cyan,  col_pink  },
};
